        ...
        <section class="page-component">
            <div v-if="showheader" class="bg-light p-3 mb-3">
                <div class="container-fluid">
                    <div class="row ">
                        <div  class="col-sm-9 comp-grid" :class="setGridSize">
                            <h3 class="record-title">Products</h3>
                        </div>
                        <div  class="col-sm-1 comp-grid" :class="setGridSize">
                            <router-link v-if="addbutton" class="btn btn btn-primary btn-block" :to="'/products/add'">
                            <i class="fa fa-plus"></i>
                            Add 
                            </router-link>
                        </div>
                        <div v-if="searchfield" class="col-sm-2 comp-grid" :class="setGridSize">
